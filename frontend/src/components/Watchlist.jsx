...
export default function Watchlist({ assets, notes, theme, onNotes, onEdit, onDelete, onRefreshData, onAdd }) {
  ...
  return (
    <div className="section active">
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '10px', marginTop: '16px' }}>
        {assets.length
          ? assets.map(a => <AssetRow key={a.id} a={a} noteCount={noteCount(a.id)} theme={theme} onNotes={onNotes} onEdit={onEdit} onDelete={onDelete} onRefreshData={onRefreshData} />)
