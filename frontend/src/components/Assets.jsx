...
export default function Assets({ assets, notes, theme, onNotes, onEdit, onDelete }) {
  ...
  return (
    <div className="section active">
      ...
      <div style={{ display:'flex', flexDirection:'column', gap:'10px', marginTop:'16px' }}>
        {filtered.length
          ? filtered.map(a => <AssetRow key={a.id} a={a} noteCount={noteCount(a.id)} theme={theme} onNotes={onNotes} onEdit={onEdit} onDelete={onDelete} />)
