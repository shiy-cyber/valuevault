    ...
    <div className="section active">
      ...
      <div className="learn-card" style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
        ...
        <div>
          ...
          <div style={{ fontSize: '11px', color: 'var(--muted)' }}>Publicaciones que mencionan este valor</div>
        </div>
      </div>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '12px', marginTop: '18px' }}>
        {loading ? (
          ...
          <div className="empty-state"><div className="empty-icon">🗣</div><div className="empty-text">Nadie ha mencionado ${ticker} todavía.</div></div>
        ) : (
          <>
            {posts.map(p => (
