...
export const ASSET_NUM = ['price','current','pe','fpe','pb','peg','evebitda','ps','eps','epsd','epsny','epsg','roe','roa','gm','om','nm','de','cr','qr','dy','pr','beta','w52h','w52l'];
export const ASSET_TXT = ['ticker','name','sector','market','mcap','risk','thesis'];
